...
input_frame = Frame(window, width = 400, height = 50, bd = 0, highlightbackground = "black", highlightcolor = "black", highlightthickness = 1)
...
btns_frame = Frame(window, width = 400, height = 350, bg = "grey")
btns_frame.pack()
